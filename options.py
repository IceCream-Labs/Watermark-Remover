...
class Options():
    ...
    def init(self, parser):        
        ...
        parser.add_argument('--basnet_weights',default='',type=str,metavar='PATH',help='path to BASNet Segmentation module')
        ...
        parser.add_argument('--k_center', default=1,type=int, help='traiSn batchsize')
        ...
        parser.add_argument('--bg_remove_only',default='False',type=str,help='omit watermark removal module')
